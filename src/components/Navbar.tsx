...
import lokeshLogo from "/lokesh logo.png";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" fixed w-full z-20 top-0 start-0 bg-transparent backdrop-blur-2xl">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            href="/"
            className="flex items-center space-x-3 rtl:space-x-reverse"
          >
            <img src={lokeshLogo} className="h-8" alt="Flowbite Logo" />
          </a>
